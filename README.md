...
Plugin WordPress para gerenciamento de reservas com protecao anti-overbooking.
...
4. Va em Plugins e ative o ExoBooking Core

## Teste de Concorrencia

Dispare 5 requisicoes simultaneas para:
